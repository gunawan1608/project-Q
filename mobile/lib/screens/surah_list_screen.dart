  ...
  Widget build(BuildContext context) => Center(
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          FadeTransition(
            ...
            child: const Text('بِسْمِ اللَّهِ',
                style: TextStyle(
                    fontFamily: 'Amiri',
                    fontSize: 34,
...
class _BodyState extends ConsumerState<_Body>
  ...
  List<SurahSummary> _filter(String q) {
    ...
    return widget.surahs.where((s) {
      ...
      final id =
          idx < surahNamesId.length ? surahNamesId[idx].toLowerCase() : '';
    ...
    return AnimatedContainer(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: _focused
            ? [
                BoxShadow(
                  color: AppTheme.green700.withValues(alpha: .13),
                  blurRadius: 10,
...
class _SurahCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final name =
        idx < surahNamesId.length ? surahNamesId[idx] : surah.englishName;
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      decoration: BoxDecoration(
        ...
        border:
            Border.all(color: d ? AppTheme.darkBorder : AppTheme.green900op06),
        boxShadow: [
          BoxShadow(
    ...
    return Center(
      ...
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        Icon(Icons.wifi_off_rounded,
            size: 52, color: d ? AppTheme.darkSubtext : AppTheme.green900op40),
